...
$facturas = ControladorFunciones::ctrMostrarFacturasRegistradas($idParticipante);
        ...
        <div class="content-wrapper ">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Mis Facturas Registradas</p>
                        ...
                        if ($total > 0) {
                          ...
                          foreach ($facturas as $key => $value) {
                            ...
                            echo "<tr>
                                        ...
                                        <td><label class='badge badge-success'>$ " . number_format($value["clasificacion1"], 2) . "</label></td>
